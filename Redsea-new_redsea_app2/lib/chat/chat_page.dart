...
class _ChatPageState extends State<ChatPage> with TickerProviderStateMixin {
  ...
  /// إظهار حوار الإبلاغ عن المستخدم
        ...
        builder: (context, setState) => AlertDialog(
          ...
          title: Row(
            children: [
              ...
              const Text('الإبلاغ عن المستخدم'),
            ],
          ),
          content: SingleChildScrollView(
            child: Column(
              ...
              children: [
                Text(
                  'الإبلاغ عن: ${widget.otherUserName}',
    ...
    if (confirmed == true && selectedReason != null && mounted) {
      ...
      if (mounted) {
        if (success) {
          Get.snackbar(
            'تم الإرسال',
            'تم إرسال البلاغ بنجاح وسيقوم المدير بمراجعته',
          ...
          Get.snackbar(
            'خطأ',
            'فشل في إرسال البلاغ، يرجى المحاولة لاحقاً',
