        ...
        children: [
          ...
          Container(
            ...
            child: OutlinedButton.icon(
              onPressed: () {
                Get.snackbar('قريباً', 'ميزة المحادثة قادمة قريباً');
              },
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return Obx(() => GestureDetector(
                            ...
                            child: Container(
                              ...
                              decoration: BoxDecoration(
                                color: selectedService.value?.id == myService.id
                                    ? AppColors.primary.withValues(alpha: 0.1)
                                    : Colors.grey.shade100,
                                borderRadius: BorderRadius.circular(12),
                                border: Border.all(
                                  color:
                                      selectedService.value?.id == myService.id
                                          ? AppColors.primary
                                          : Colors.transparent,
                                  width: 2,
                                ),
                              ...
                              child: Column(
                                ...
                                children: [
                                  Icon(
                                    ServiceCategory.getIcon(myService.category),
